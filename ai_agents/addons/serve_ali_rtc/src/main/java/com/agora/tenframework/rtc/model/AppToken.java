...
import com.agora.tenframework.rtc.constant.SecurityConstants;
import com.agora.tenframework.rtc.util.CompressUtils;
import com.agora.tenframework.rtc.util.EncodeUtils;
import com.agora.tenframework.rtc.util.SignatureUtils;
...
public class AppToken {
    ...
    public void addService(@NonNull RtcService rtcService) {
    ...
    public String buildTokenString() throws Throwable {
        ...
        if (Objects.isNull(this.rtcService)) {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        final RtcService rtcService = new RtcService(channelId, userId);
        appToken.addService(rtcService);
        System.out.println(expiredTs);
