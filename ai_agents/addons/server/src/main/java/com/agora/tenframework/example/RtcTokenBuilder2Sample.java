...
/**
 * RTC Token Builder2 Sample - Demonstrates how to use Agora Java SDK
...
public class RtcTokenBuilder2Sample {
    ...
    public static void main(String[] args) {
        ...
        result = token.buildTokenWithUserAccount(appId, appCertificate, channelName, account, Role.ROLE_PUBLISHER,
        ...
        System.out.printf("Token with RTM2: %s\n", result);
    }
}